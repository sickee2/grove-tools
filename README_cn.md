...
| 操作类型 | std::format | fmt::format | toy::format | 性能提升 |
|---------|-------------|-------------|-------------|----------|
| 整数格式化 | 5997μs | 2621μs | 2575μs | **比 std::format 快 133%，比 fmt::format 快 1.8%** |
| 浮点数格式化 | 7947μs | 5358μs | 4068μs | **比 std::format 快 95%，比 fmt::format 快 32%** |
| 字符串格式化 | 4039μs | 3234μs | 2063μs | **比 std::format 快 96%，比 fmt::format 快 57%** |
| 指针格式化 | 1252μs | 1171μs | 561μs | **比 std::format 快 123%，比 fmt::format 快 109%** |
| 总体吞吐量 | 7.03M ops/sec | 12.98M ops/sec | 13.74M ops/sec | **比 std::format 高 96%，比 fmt::format 高 6%** |
| 内存分配 | 1574μs | - | 879μs | **比 std::format 快 79%** |
